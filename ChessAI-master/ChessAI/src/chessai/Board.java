...
public class Board {
	...
	board[7][7].setPiece(new Rook(false,7,7,"r"));
	board[7][1].setPiece(new Knight(false,1,7,"n"));
	board[7][6].setPiece(new Knight(false,6,7,"n"));
	board[7][2].setPiece(new Bishop(false,2,7,"b"));
	board[7][5].setPiece(new Bishop(false,05,7,"b"));
	board[7][3].setPiece(new Queen(false,3,7,"q"));
	board[7][4].setPiece(new King(false,4,7,"k"));
	//White pawns
	for(int x=0;x<8;x++){
	    board[6][x].setPiece(new Pawn(false,x,6,"p"));
